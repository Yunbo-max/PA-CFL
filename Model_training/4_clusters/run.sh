...
# @Last Modified time: 2024-03-10 07:45:48
#!/bin/bash
set -e
...
sheet_names=('West of USA' 'US Center' 'West Africa' 'North Africa' 'Central America' 'South America' 'East of USA' 'South of  USA')
