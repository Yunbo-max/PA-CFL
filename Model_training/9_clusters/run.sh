...
# @Last Modified time: 2024-03-10 08:11:38
#!/bin/bash
set -e
...
# sheet_names=('South Asia' 'Western Europe'  'Southern Europe')
# sheet_names=('West of USA' 'US Center' 'West Africa' 'South of  USA')

# sheet_names=('North Africa' 'East of USA')
sheet_names=('Central America' 'South America')

# sheet_names=('Southeast Asia' 'Eastern Asia')
