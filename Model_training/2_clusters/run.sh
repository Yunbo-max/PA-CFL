...
# @Last Modified time: 2024-03-09 18:59:41
#!/bin/bash
set -e
...
# sheet_names=( 'South Asia' 'Oceania' 'West of USA' 'US Center' 'West Africa' 'North Africa' 'Western Europe' 'Central America' 'South America' 'Southern Europe' 'East of USA' 'South of  USA')
