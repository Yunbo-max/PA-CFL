...
# @Last Modified time: 2024-02-12 15:48:03
# -*- coding = utf-8 -*-
...
config = {"region": value}
wandb.init(project='Cambridge_sales_MLP_FL_8.5_east', config=config)
...
class RegressionClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config=None):
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('scatter_plot10.png')
        wandb.log({'Scatter Plot': wandb.Image('scatter_plot10.png')})
        plt.close()
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('distribution_plot10.png')
        wandb.log({'Distribution Plot': wandb.Image('distribution_plot10.png')})
        plt.close()
