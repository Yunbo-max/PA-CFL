...
# @Last Modified time: 2024-02-12 20:37:12
# -*- coding = utf-8 -*-
...
class RegressionClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config=None):
        ...
        wandb.log({'Scatter Plot': wandb.Image('scatter_plot3.png')})
        plt.close()
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('distribution_plot3.png')
        wandb.log({'Distribution Plot': wandb.Image('distribution_plot3.png')})
        plt.close()
