...
# @Last Modified time: 2024-02-12 13:58:36
# -*- coding = utf-8 -*-
...
class RegressionClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config=None):
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('scatter_plot20.png')
        wandb.log({'Scatter Plot': wandb.Image('scatter_plot20.png')})
        plt.close()
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('distribution_plot20.png')
        wandb.log({'Distribution Plot': wandb.Image('distribution_plot20.png')})
        plt.close()
